...
public class CampusGraph {
    // Adjacency list to store graph: Location Name -> List of connected Location objects
    ...
    public void removeLocation(String locationName) {
        ...
        for (String loc adjList.keySet()) {
            adjList.get(loc).removeIf(1 -> 1.getName().equals(locationName));
        } 
    ...
    public void removeConnection(String loc1, String loc2) {
        ...
        boolean connected list1.stream().anyMatch (1 -> 1.getName().equals(loc2));
        if (!connected) {
            System.out.println("Error: No connection exists between" + loc1 + "and" + loc2);
            return;
        }

        list1.removeIf(1 -> 1.getName().equals(loc2));
        list2.removeIf(1 -> 1.getName().equals(loc1));
